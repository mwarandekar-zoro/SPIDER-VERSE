...
import CrazySpiderVerseTitle from './CrazySpiderVerseTitle';
...
export default function Navbar({ onLogoFrenzy, onTriggerChaos }) {
  ...
  function handleLogoClick(e) {
    ...
    // Trigger Multiverse Glitch Frenzy on 3 fast clicks
  ...
  return (
    ...
    >
      <a
        ...
        title="3 quick clicks = Multiverse Glitch Frenzy!"
        style={{ pointerEvents: 'auto', display: 'inline-flex', alignItems: 'center' }}
        onPointerEnter={() => setCursor('button', 'GLITCH')}
        onPointerLeave={() => setCursor('default')}
      >
        <CrazySpiderVerseTitle text="SPIDER-VERSE" as="span" fontSize="1rem" />
      </a>
